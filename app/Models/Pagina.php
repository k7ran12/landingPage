...
class Pagina extends Model
{
    ...
    static $rules = [
		'sec1_logo' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		'sec1_bannerimagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		...
		'sec2_card1_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		'sec2_card1_titulo' => 'required',
		'sec2_card1_subtitulo' => 'required',
		'sec2_card2_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		'sec2_card2_titulo' => 'required',
		'sec2_card2_subtitulo' => 'required',
		'sec2_card3_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		...
		'sec4_card1_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		'sec4_card2_titulo' => 'required',
		'sec4_card2_subtitulo' => 'required',
		'sec4_card2_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		'sec5_titulo' => 'required',
		'sec5_subtitulo' => 'required',
		'sec5_card1_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
		'sec5_card1_titulo' => 'required',
		'sec5_card1_subtitulo' => 'required',
		'sec5_card2_imagen' => 'required|image|mimes:jpeg,png,jpg,gif,svg',
